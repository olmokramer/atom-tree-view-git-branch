...
export var config = {
  location: {
    description: 'location of the items in the tree view.  top: all at the top of the tree view. before: before the corresponding project directory. inside: as the first item in the corresponding project directory, this is the default.',
    type: 'string',
    default: 'inside',
    enum: [
      'top',
